...
//   const [isSidesModalOpen, setIsSidesModalOpen] = useState(false);
//   const [isActionsModalOpen, setIsActionsModalOpen] = useState(false);
//   const [flowStage, setFlowStage] = useState('tableSelection');
//   const [allOrders, setAllOrders] = useState([]);
...
//     setAllOrders([...allOrders, newOrder]);
//     navigate("/staff/billingpayment", { state: { order: newOrder } });
//   };
...
//                             <td>{new Date(order.timestamp).toLocaleTimeString()}</td>
//                             <td>
//                               <Link to="/staff/billingpayment" state={{ order }}>
...
//                   aria-label="Close"
//                   onClick={() => {
//                     if (flowStage === 'customerDetails' && !customerInfo.name.trim()) {
