...
//   const tablesByCategory = categoryOrder.map(type => ({
//     type,
//     tables: allTableData.filter(table => table.type === type)
//   }));
...
//         borderRadius: table.type === "Food" ? "50%" : "12px",
//         margin: "15px",
//         padding: "12px",
//         minWidth: "110px",
//         maxWidth: "150px",
...
//       </div>
//       <div style={{ fontWeight: "bold", color: "#333", marginBottom: "3px", textAlign: "center" }}>
//         {table.name}
//       </div>
...
//           cat.tables.length ? (
//             <div key={cat.type} style={{ marginBottom: "30px" }}>
//               <h2
//                 style={{
...
//                 }}
//               >
//                 {getCategoryIcon(cat.type)} {cat.type} Tables
//               </h2>
